...
export { BlockToken, InlineToken, Heading, Paragraph, InlineCode, Bold, Underline, Italics, InlineText };

BlockToken.useRule("heading", Heading.rule, Heading.parse, 10);
BlockToken.useRule("paragraph", Paragraph.rule, Paragraph.parse, 1000);

InlineToken.useRule("inline-code", InlineCode.rule, InlineCode.parse, 10);
InlineToken.useRule("bold", Bold.rule, Bold.parse, 20);
InlineToken.useRule("underline", Underline.rule, Underline.parse, 30);
InlineToken.useRule("italics", Italics.rule, Italics.parse, 40);
